...
const NODE_FIELD0B_OFFSET = 6;
const NODE_HEADER_U32S = 2;
const NODE_DATA_SLOTS = 7;
const NODE_SPAN_START_U32 = 9;
const NODE_SPAN_END_U32 = 10;
...
function encode(program) {
  ...
  function encDialectRecord(n, schema, hostIdx) {
    ...
    try {
      ...
      new DataView(ab).setUint16(2, packedFlags, true);
  ...
  function encDialectDirect(n, schema) {
    ...
    const idx = alloc(); tagAt(idx, 171); slotAt(idx, 0, ri);
  ...
  function enc_program(n) {
    ...
    flagsAt(idx, (n.sourceType === "script" ? 0 : 1) | (hb ? 4 : 0));
    spanAt(idx, asStart(n), asEnd(n));
    recordComments(n, idx);
    return idx;
  }
  ...
  const finalSize =
    ...
    totalOffsetsBytes + totalAttachedBytes + totalDialectBytes;
  ...
  outU32[6] = 0;
  outU32[7] = progIdx;
  outU32[8] = (attached ? FLAG_ATTACHED_COMMENTS : 0) | (root[DIALECT_TS] === true ? 1 : 0) | (dialectRecords.length ? 16 : 0);
  outU32[9] = 0;
