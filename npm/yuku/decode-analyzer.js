...
const DIALECT_RECORDS = Object.freeze([
  ...
  Object.freeze({ tag: 175, type: "JSXCodeBlock", overlay: false, fields: Object.freeze([Object.freeze({ name: "body", role: "nodeList", slot: 2, bit: 0 }), Object.freeze({ name: "render", role: "optionalNode", slot: 4, bit: 0 })]) }),
  Object.freeze({ tag: 176, type: "JSXForExpression", overlay: false, fields: Object.freeze([Object.freeze({ name: "statement", role: "node", slot: 2, bit: 0 }), Object.freeze({ name: "empty", role: "optionalNode", slot: 3, bit: 0 })]) }),
  Object.freeze({ tag: 177, type: "JSXIfExpression", overlay: false, fields: Object.freeze([Object.freeze({ name: "test", role: "node", slot: 2, bit: 0 }), Object.freeze({ name: "consequent", role: "node", slot: 3, bit: 0 }), Object.freeze({ name: "alternate", role: "optionalNode", slot: 4, bit: 0 })]) }),
  Object.freeze({ tag: 178, type: "JSXSwitchExpression", overlay: false, fields: Object.freeze([Object.freeze({ name: "statement", role: "node", slot: 2, bit: 0 })]) }),
  Object.freeze({ tag: 179, type: "JSXTryExpression", overlay: false, fields: Object.freeze([Object.freeze({ name: "statement", role: "node", slot: 2, bit: 0 }), Object.freeze({ name: "pending", role: "optionalNode", slot: 3, bit: 0 })]) }),
  Object.freeze({ tag: 180, type: "StyleSheet", overlay: false, fields: Object.freeze([Object.freeze({ name: "source", role: "string", slot: 2, bit: 0 }), Object.freeze({ name: "children", role: "nodeList", slot: 4, bit: 0 }), Object.freeze({ name: "scanned", role: "bool", slot: 6, bit: 0 })]) }),
  Object.freeze({ tag: 181, type: "JSXStyleElement", overlay: false, fields: Object.freeze([Object.freeze({ name: "openingElement", role: "node", slot: 2, bit: 0 }), Object.freeze({ name: "children", role: "nodeList", slot: 3, bit: 0 }), Object.freeze({ name: "closingElement", role: "optionalNode", slot: 5, bit: 0 }), Object.freeze({ name: "css", role: "string", slot: 6, bit: 0 })]) }),
  Object.freeze({ tag: 182, type: "TSRXExpression", overlay: false, fields: Object.freeze([Object.freeze({ name: "expression", role: "node", slot: 2, bit: 0 })]) }),
  Object.freeze({ tag: 183, type: "CssRule", overlay: false, fields: Object.freeze([Object.freeze({ name: "prelude", role: "nodeList", slot: 2, bit: 0 }), Object.freeze({ name: "block", role: "nodeList", slot: 4, bit: 0 })]) }),
