// `<!-- widget:symbol-table unresolved="reset" -->` followed by a ```tsrx fence.
// The analyzer runs on the fence here so the seed is proven to land on the
// point: parses clean, and exactly the named references resolve to nothing.
